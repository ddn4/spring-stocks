...
class MarketRoutesTests {
    ...
    @Test
    @DisplayName( "Test Open Market Endpoint" )
    void testOpenMarket() {
    ...
    @Test
    @DisplayName( "Test Close Market Endpoint" )
    void testCloseMarket() {
    ...
    @Test
    @DisplayName( "Test Get Market Status Endpoint" )
