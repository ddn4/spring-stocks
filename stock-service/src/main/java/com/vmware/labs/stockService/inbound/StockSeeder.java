...
@ConditionalOnProperty( value = "spring.stocks.seeder.enabled", havingValue = "true", matchIfMissing = false )
public class StockSeeder implements ApplicationListener<ApplicationReadyEvent> {
